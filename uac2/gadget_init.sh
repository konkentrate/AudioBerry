...
GDG_DIRNAME="uac2_audio" # adapt as you like
...
STRG_MANUFACTURER="AudioBerry" # adapt as you like
STRG_PRODUCT="USB Audio DAC" # adapt as you like
...
AUDIO_CHANNEL_MASK_PLAYBACK=0
AUDIO_SAMPLE_RATES_CAPTURE=44100
AUDIO_SAMPLE_RATES_PLAYBACK=44100
...
echo -12800 > functions/uac2.usb0/p_volume_min
